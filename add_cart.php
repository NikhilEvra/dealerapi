...
if($con){ 
    $sql = "INSERT INTO `cart`(`id`, `status`, `dealer_id`, `model`, `varient`, `quantity_with_batt`, `quantity_without_batt`, `amountWithOutBatt`,
     `amountWithBatt`, `without_tax_total`, `total`, `add_time`, `add_date`) 
