...
$t = date("h:i:sa");
    ...
    if($con){ 
        ...
        $sql = "INSERT INTO `notifications`(`id`, `panel`, `message`, `status`, `date`, `time`, `sender_panel`, `sender_id`,`po_id`)
                VALUES (Null,'Services','PO Recieved Back From Operations','Active','$d','$t','Operations','$panel_id','$po_id')";
        ...
        `dept_status`='PO_s_by_operation_payment_default',
        `operations_remarks2`='$remarks'
         WHERE po_id = '$po_id'"; 
