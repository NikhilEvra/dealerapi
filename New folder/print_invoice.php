...
include ('config.php');
if($con){
    $data="select * from customer_sale_master where invoice_id = '$invoice_id' ";
  ...
  $data1="select * from user_master where u_id = '$id' ";
...
<!--<a href="https://evramedia.com"><button>Back</button></a>-->